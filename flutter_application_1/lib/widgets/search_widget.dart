                    ...
                    Row(
                      children: [
                        ...
                        TextButton(
                            ...
                            onPressed: () {
                              context.go(
                                  '/TripDetails/${allTrips[index].tripid}/${allTrips[index].description}/${allTrips[index].price}/${allTrips[index].location}}/${allTrips[index].tripName}/${allTrips[index].startDate}}/${allTrips[index].endDate}}/');
                            }),
                      ],
                    )
                  ],
